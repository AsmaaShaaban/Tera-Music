namespace MVCProJect.Migrations
{
    ...
    public partial class InitialData : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        IsSubscribedToNewsLetters = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Name = c.String(nullable: false, maxLength: 255),
                        InstructorName = c.String(maxLength: 255),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.MusicInstruments", "GenreId", "dbo.Genres");
            ...
            DropIndex("dbo.MusicInstruments", new[] { "GenreId" });
